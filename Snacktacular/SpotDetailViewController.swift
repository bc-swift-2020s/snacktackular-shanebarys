...
class SpotDetailViewController: UIViewController {
    ...
    var spot: Spot!
    let regionDistance : CLLocationDistance = 750 // 750 meters of about half a mile
...
extension SpotDetailViewController: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .denied:
            showAlertToPrivacySettings(title: "User has not authorized location services", message: "Select 'Settings' below to open device settings and enable location servives for this app")
        case.restricted:
